...
class Settings extends Component {
  ...
  render() {
    const { disableBalanceOnEdit, disableBalanceOnAdd, allowRegistration } = this.props.settings;
          ...
          <div className="card-body">
            <form>
              <div className="form-group">
                ...
                {' '}
                <input type="checkbox" name="allowRegistration" checked={allowRegistration} onChange={this.allowRegistrationOnChange}/>
              </div>
              <div className="form-group">
                <label> {' '}
